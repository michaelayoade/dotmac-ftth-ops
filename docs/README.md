...
### `/api` — API References  
Endpoint summaries, example payloads, and integration notes.

### `/architecture` — Architecture Documentation  
System design decisions, portal navigation, runtime execution paths, and infrastructure notes.

### `/billing` — Billing Playbooks  
