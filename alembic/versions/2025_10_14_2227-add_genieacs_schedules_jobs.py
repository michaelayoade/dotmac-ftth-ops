...
down_revision: Union[str, None] = '5a517bdd0997'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('file_type', sa.String(length=100), nullable=True, server_default='1 Firmware Upgrade Image'),
    ...
    op.create_index('ix_firmware_schedules_tenant_status', 'firmware_upgrade_schedules', ['tenant_id', 'status'])
    op.create_index('ix_firmware_schedules_scheduled_at', 'firmware_upgrade_schedules', ['scheduled_at'])
    ...
    op.create_index('ix_firmware_results_schedule_status', 'firmware_upgrade_results', ['schedule_id', 'status'])
    ...
    op.create_index('ix_mass_config_jobs_tenant_status', 'mass_config_jobs', ['tenant_id', 'status'])
    ...
    op.create_index('ix_mass_config_results_job_status', 'mass_config_results', ['job_id', 'status'])
