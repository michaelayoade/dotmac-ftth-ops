...
export class PartnerApiClient {
  ...
  async getDashboard(partnerId: string): Promise<ApiResponse<DashboardData>> {
    ...
    const response = await this.client.request<ApiResponse<DashboardData>>(
      `/api/isp/v1/partners/${sanitizedPartnerId}/dashboard`,
      {
        method: "GET",
      },
    );
  ...
  async getCustomers(
    ...
    >(`/api/isp/v1/partners/${sanitizedPartnerId}/customers?${searchParams.toString()}`, {
      method: "GET",
    });
  ...
  async getCustomer(partnerId: string, customerId: string): Promise<ApiResponse<Customer>> {
    ...
    const response = await this.client.request<ApiResponse<Customer>>(
      `/api/isp/v1/partners/${sanitizedPartnerId}/customers/${sanitizedCustomerId}`,
      {
        method: "GET",
      },
    );
  ...
  async createCustomer(
    ...
    const response = await this.client.request<ApiResponse<Customer>>(
      `/api/isp/v1/partners/${sanitizedPartnerId}/customers`,
      {
        method: "POST",
  ...
  > {
    ...
    >(`/api/isp/v1/partners/${partnerId}/commissions?${searchParams.toString()}`, {
      method: "GET",
    });
  }
  ...
  async getAnalytics(
    ...
    return this.client.request<ApiResponse<any>>(
      `/api/isp/v1/partners/${partnerId}/analytics?${searchParams.toString()}`,
      {
        method: "GET",
      },
    );
  ...
  async validateTerritory(
    ...
    return this.client.request<ApiResponse<{ valid: boolean; territory: string }>>(
      `/api/isp/v1/partners/${validatedData.partnerId}/validate-territory`,
      {
        method: "POST",
