...
- `GET /api/isp/v1/customers/{id}/invoices` - List invoices
- `GET /api/isp/v1/customers/{id}/payments` - List payments
- `GET /api/isp/v1/customers/{id}/billing-summary` - Get summary

### Invoices

- `GET /api/isp/v1/invoices` - List all invoices
- `GET /api/isp/v1/invoices/{id}` - Get invoice details
- `GET /api/isp/v1/invoices/{id}/download` - Download PDF
- `POST /api/isp/v1/invoices/{id}/email` - Email invoice

### Payments

- `GET /api/isp/v1/payments` - List all payments
- `GET /api/isp/v1/payments/{id}` - Get payment details
- `POST /api/isp/v1/payments` - Record payment

### Payment Methods

- `GET /api/isp/v1/customers/{id}/payment-methods` - List payment methods
- `POST /api/isp/v1/customers/{id}/payment-methods` - Add payment method
- `DELETE /api/isp/v1/customers/{id}/payment-methods/{id}` - Remove payment method

### Receipts

- `GET /api/isp/v1/receipts` - List receipts
- `GET /api/isp/v1/receipts/{id}` - Get receipt details
- `GET /api/isp/v1/receipts/{id}/download` - Download PDF

### Credit Notes

- `POST /api/isp/v1/invoices/{id}/credit-notes` - Create credit note
