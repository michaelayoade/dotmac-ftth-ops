...
- `GET /api/isp/v1/leads` - List leads
- `POST /api/isp/v1/leads` - Create lead
- `GET /api/isp/v1/leads/{id}` - Get lead details
- `PUT /api/isp/v1/leads/{id}` - Update lead
- `POST /api/isp/v1/leads/{id}/convert` - Convert to customer

### Quotes

- `GET /api/isp/v1/quotes` - List quotes
- `POST /api/isp/v1/quotes` - Create quote
- `GET /api/isp/v1/quotes/{id}` - Get quote details
- `PUT /api/isp/v1/quotes/{id}` - Update quote
- `POST /api/isp/v1/quotes/{id}/send` - Send to customer
- `POST /api/isp/v1/quotes/{id}/accept` - Accept quote
- `POST /api/isp/v1/quotes/{id}/reject` - Reject quote
- `GET /api/isp/v1/quotes/{id}/download` - Download PDF

### Surveys

- `GET /api/isp/v1/surveys` - List surveys
- `POST /api/isp/v1/surveys` - Create survey
- `GET /api/isp/v1/surveys/{id}` - Get survey details
- `PUT /api/isp/v1/surveys/{id}` - Update survey
- `POST /api/isp/v1/surveys/{id}/complete` - Complete survey
...
test("creates lead", async () => {
  ...
  await waitFor(() => {
    expect(mockApiClient.post).toHaveBeenCalledWith("/api/isp/v1/leads", expect.any(Object));
