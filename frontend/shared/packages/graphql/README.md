...
- Default: `/api/platform/v1/graphql` (matches backend route at `src/dotmac/platform/routers.py:881`)
...
// Client will use: https://api.example.com/api/platform/v1/graphql
