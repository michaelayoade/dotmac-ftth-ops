 ...
 * - GET /api/platform/v1/users - List all users
 * - GET /api/platform/v1/users/{id} - Get user details
 * - GET /api/platform/v1/users/me - Current user
 * - PUT /api/platform/v1/users/{id} - Update user
 * - DELETE /api/platform/v1/users/{id} - Delete user
 * - POST /api/platform/v1/users/{id}/disable - Disable user
 * - POST /api/platform/v1/users/{id}/enable - Enable user
 */
