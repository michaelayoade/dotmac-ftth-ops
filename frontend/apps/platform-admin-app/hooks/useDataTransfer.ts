 ...
 * - POST /api/platform/v1/data-transfer/import - Create import job
 * - POST /api/platform/v1/data-transfer/export - Create export job
 * - GET /api/platform/v1/data-transfer/jobs - List jobs with filters
 * - GET /api/platform/v1/data-transfer/jobs/{job_id} - Get job status
 * - DELETE /api/platform/v1/data-transfer/jobs/{job_id} - Cancel job
 * - GET /api/platform/v1/data-transfer/formats - Get supported formats
 */
