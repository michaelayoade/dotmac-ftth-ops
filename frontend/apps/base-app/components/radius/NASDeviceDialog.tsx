...
const NAS_TYPES = ["other", "router", "olt", "wireless", "switch", "vpn", "access-point"];
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) =>
                  setFormData((prev) => ({ ...prev, nasname: event.target.value }))
                }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) =>
                  setFormData((prev) => ({ ...prev, server: event.target.value }))
                }
                placeholder="radius1"
              />
            </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) =>
                  setFormData((prev) => ({ ...prev, secret: event.target.value }))
                }
                placeholder="••••••••"
              />
            </div>
