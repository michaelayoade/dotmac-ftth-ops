...
function AddressGroupRow({ group, showTenant, onEdit, onDelete, onCopy }: AddressGroupRowProps) {
          ...
          <div className="space-y-1">
            {ipv4 && (
              <div className="flex items-center gap-2">
                <span className="font-mono text-sm">{formatIPAddress(ipv4.address)}</span>
                <Button
                  variant="ghost"
                  size="sm"
            ...
            {ipv6 && (
              <div className="flex items-center gap-2">
                <span className="font-mono text-sm">{formatIPAddress(ipv6.address)}</span>
                <Button
                  variant="ghost"
                  size="sm"
  ...
  return (
    <TableRow>
      <TableCell>
        <div className="flex items-center gap-2">
          <span className="font-mono font-medium">{formatIPAddress(addr.address)}</span>
          <Button
            variant="ghost"
            size="sm"
