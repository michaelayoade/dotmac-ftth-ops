...
import { createTestUser, loginUser, cleanupServers, cleanupPeers, provisionVPN } from '../../helpers/api-helpers';
...
test.describe('WireGuard Provisioning', () => {
  ...
  test.describe('Loading States', () => {
    ...
    test('should show progress during provisioning', async ({ page }) => {
      ...
      await expect(page.locator('text=Creating peers')).toBeVisible({ timeout: 10000 });
    });
  });
});
