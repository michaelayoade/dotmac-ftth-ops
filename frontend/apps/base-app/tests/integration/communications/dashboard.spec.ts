...
test.describe("Communications Dashboard", () => {
  ...
  test.describe("System Health", () => {
    ...
    test("should show healthy status when SMTP is connected", async ({ page }) => {
      ...
      // Assert
      await expect(
        page.locator('[data-testid="smtp-status"][data-health="healthy"]'),
      ).toBeVisible();
    });
    ...
    test("should show warning when SMTP has issues", async ({ page }) => {
      ...
      // Assert
      await expect(
        page.locator('[data-testid="smtp-status"][data-health="degraded"]'),
      ).toBeVisible();
    });
  ...
  test.describe("Recent Activity", () => {
    ...
    test("should show email delivery status", async ({ page }) => {
      ...
      // Assert
      await expect(
        page.locator('[data-testid="activity-item"][data-status="delivered"]'),
      ).toBeVisible();
    });
