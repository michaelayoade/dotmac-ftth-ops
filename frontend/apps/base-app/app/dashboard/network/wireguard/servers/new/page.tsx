...
export default function CreateServerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const submitData: WireGuardServerCreate = {
      ...
      server_ipv6: formData.server_ipv6 || undefined,
  ...
  const handleFieldChange = (
    field: keyof WireGuardServerCreate,
    value: unknown
  ) => {
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFieldChange('server_ipv6', e.target.value)
                  }
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-muted-foreground mt-1">
                Send keepalive packets every N seconds (0 = disabled, default:
                25)
              </p>
            </div>
          </div>
