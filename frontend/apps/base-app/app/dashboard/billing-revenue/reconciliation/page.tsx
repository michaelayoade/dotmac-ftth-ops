...
const fetchReconciliationSummary = async (): Promise<ReconciliationSummary> => {
...
const createReconciliation = async (data: ReconciliationStart): Promise<ReconciliationSession> => {
...
const completeReconciliation = async (id: number): Promise<ReconciliationSession> => {
...
const approveReconciliation = async (id: number): Promise<ReconciliationSession> => {
...
export default function ReconciliationPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Success',
        description: 'Reconciliation session created successfully',
      });
    ...
    onError: (error: Error) => {
      toast({
        title: 'Error',
        description: `Failed to create reconciliation: ${error.message}`,
        variant: 'destructive',
      });
    },
  });
  ...
  const completeMutation = useMutation({
    ...
    onError: (error: Error) => {
      toast({
        title: 'Error',
        description: `Failed to complete reconciliation: ${error.message}`,
        variant: 'destructive',
      });
    },
  });
  ...
  const approveMutation = useMutation({
    mutationFn: approveReconciliation,
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['reconciliations'] });
      queryClient.invalidateQueries({ queryKey: ['reconciliation-summary'] });
      toast({
    ...
    onError: (error: Error) => {
      toast({
        title: 'Error',
        description: `Failed to approve reconciliation: ${error.message}`,
        variant: 'destructive',
      });
    },
  });
