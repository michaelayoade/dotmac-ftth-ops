...
export function useAWXHealth(
  options?: Omit<UseQueryOptions<AWXHealthResponse, Error, AWXHealthResponse, HealthQueryKey>, 'queryKey' | 'queryFn'>
...
export function useJobTemplates(
  options?: Omit<UseQueryOptions<JobTemplate[], Error, JobTemplate[], TemplatesQueryKey>, 'queryKey' | 'queryFn'>
...
export function useJobTemplate(
  ...
  options?: Omit<UseQueryOptions<JobTemplate, Error, JobTemplate, TemplateQueryKey>, 'queryKey' | 'queryFn'>
): UseQueryResult<JobTemplate, Error> {
