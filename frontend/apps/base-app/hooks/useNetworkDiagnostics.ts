...
export function useNetworkDiagnostics() {
  ...
  const disconnectSession = useMutation({
    ...
    onError: (error: any, variables) => {
      ...
      toast({
        ...
        description: error.response?.data?.detail || 'Unable to disconnect session. Please try again.',
        variant: 'destructive',
      });
    },
  });
  ...
  const tracerouteDevice = useMutation({
    ...
    onError: (error: any, variables) => {
      ...
      toast({
        ...
        description: error.response?.data?.detail || 'Unable to traceroute device. Please try again.',
        variant: 'destructive',
      });
    },
  });
  ...
  return {
    ...
    isLoading:
      ...
      pingDevice.isPending ||
      tracerouteDevice.isPending,
