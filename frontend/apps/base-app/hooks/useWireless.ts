...
const DEFAULT_MAP_LAYERS: MapLayer[] = [
  { id: 'access_points', name: 'Access Points', type: 'access_points', visible: true, color: '#3b82f6', opacity: 1 },
  { id: 'coverage_zones', name: 'Coverage Zones', type: 'coverage_zones', visible: true, color: '#10b981', opacity: 0.3 },
  { id: 'signal_heat_map', name: 'Signal Heat Map', type: 'signal_heat_map', visible: false, color: '#f59e0b', opacity: 0.5 },
  { id: 'clients', name: 'Connected Clients', type: 'clients', visible: true, color: '#8b5cf6', opacity: 1 },
  { id: 'interference', name: 'Interference', type: 'interference', visible: false, color: '#ef4444', opacity: 0.7 },
  { id: 'site_survey', name: 'Site Survey', type: 'site_survey', visible: false, color: '#06b6d4', opacity: 0.8 },
];
