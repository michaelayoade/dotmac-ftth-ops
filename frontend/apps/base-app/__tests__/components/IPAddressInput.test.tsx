...
describe("IPAddressInput", () => {
  it("should render with label", () => {
    render(<IPAddressInput value="" onChange={() => {}} label="IP Address" />);
  ...
  it("should call onChange when input changes", () => {
    ...
    render(<IPAddressInput value="" onChange={handleChange} label="IP Address" />);
  ...
  it("should show validation error for invalid IP", () => {
    render(<IPAddressInput value="invalid" onChange={() => {}} label="IP Address" />);
  ...
  it("should show required indicator", () => {
    render(<IPAddressInput value="" onChange={() => {}} label="IP Address" required={true} />);
  ...
  it("should show help text", () => {
    ...
    render(<IPAddressInput value="" onChange={() => {}} label="IP Address" helpText={helpText} />);
  ...
  it("should be disabled when disabled prop is true", () => {
    render(
      <IPAddressInput value="192.168.1.1" onChange={() => {}} label="IP Address" disabled={true} />,
    );
