    ...
    <div className="container mx-auto py-8 space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Manage offline mode, notifications, and app installation
        </p>
      </div>
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">
                Receive real-time updates about task assignments, schedule changes, and
                important alerts.
              </p>
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Install dotmac Ops on your device for faster access, offline support, and a
              ...
              <div className="mt-3 p-3 bg-yellow-50 rounded-lg">
                ...
                <ul className="text-sm text-yellow-800 space-y-1">
                  {pendingCount.timeEntries > 0 && (
                    <li>{pendingCount.timeEntries} time entries</li>
                  )}
                  {pendingCount.locations > 0 && (
                    <li>{pendingCount.locations} location updates</li>
                  )}
                </ul>
              </div>
            )}
