          ...
          {loading ? (
            ...
            <div className="divide-y divide-slate-800">
              {filteredApiKeys.map((apiKey) => (
                <div key={apiKey.id} className="p-6 hover:bg-slate-800/50 transition-colors">
...
function ApiKeyActions({ apiKey, onView, onEdit, onRevoke }: ApiKeyActionsProps) {
  ...
  return (
    <div className="relative">
      ...
      {showDropdown && (
        <div className="absolute right-0 mt-2 w-48 bg-slate-800 rounded-md shadow-lg ring-1 ring-slate-700 z-10">
          <div className="py-1">
            <button
              onClick={() => {
                onView(apiKey);
