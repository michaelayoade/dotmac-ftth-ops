...
function resolveStatusBadge(
  ...
  if (activePortCount > 0 || ["ACTIVE", "ENABLED", "ONLINE"].includes(oper) || connect === "REACHABLE") {
            ...
            <CardContent className="space-y-3">
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="font-mono text-sm break-all">{logicalDevice.root_device_id || "N/A"}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Serial Number</p>
                  <p className="font-medium">{desc.serial_num || overview?.serial_number || "Unknown"}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Datapath ID</p>
                  <p className="font-mono text-sm break-all">{logicalDevice.datapath_id || "N/A"}</p>
                </div>
                <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <p className="font-medium">{desc.sw_desc || overview?.firmware_version || "Unknown"}</p>
              </div>
            </CardContent>
          </Card>
