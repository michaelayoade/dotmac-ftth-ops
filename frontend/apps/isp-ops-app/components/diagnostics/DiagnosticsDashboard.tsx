    ...
    try {
      ...
      switch (diagnosticType) {
        ...
        case DiagnosticType.ONU_STATUS:
          endpoint = `/api/v1/diagnostics/subscribers/${subscriberId}/onu-status`;
          break;
        case DiagnosticType.CPE_STATUS:
          endpoint = `/api/v1/diagnostics/subscribers/${subscriberId}/cpe-status`;
          break;
        case DiagnosticType.IP_VERIFICATION:
          endpoint = `/api/v1/diagnostics/subscribers/${subscriberId}/ip-verification`;
          break;
