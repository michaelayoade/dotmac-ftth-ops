...
const { useSubscriberOperations: mockUseSubscriberOperations } =
  jest.requireMock("@/hooks/useSubscribers") as { useSubscriberOperations: jest.Mock };
...
describe("AddSubscriberModal (App Wrapper)", () => {
  beforeEach(() => {
    ...
    mockSharedModal.mockImplementation(
      ({ open, onClose, onSuccess, useSubscriberOperations }) => (
  ...
  it("forwards open prop to shared component", () => {
    renderQuick(
      <AddSubscriberModal open={true} onClose={jest.fn()} />
    );
  ...
  it("forwards onClose prop to shared component", () => {
    ...
    renderQuick(
      <AddSubscriberModal open={true} onClose={onClose} />
    );
  ...
  it("forwards onSuccess prop to shared component", () => {
    ...
    renderQuick(
      <AddSubscriberModal open={true} onClose={jest.fn()} onSuccess={onSuccess} />
    );
  ...
  it("renders shared modal when open is false", () => {
    renderQuick(
      <AddSubscriberModal open={false} onClose={jest.fn()} />
    );
