...
export function LeadDetailModal({ isOpen, onClose, lead, onUpdate }: LeadDetailModalProps) {
  ...
  const handleQualify = async () => {
    try {
      ...
      toast({
        ...
        description: `${lead.first_name} ${lead.last_name} is now qualified.`,
      });
      if (onUpdate) onUpdate();
    } catch (error) {
  ...
  const handleDisqualify = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `${lead.first_name} ${lead.last_name} has been disqualified.`,
      });
      if (onUpdate) onUpdate();
    } catch (error) {
  ...
  const handleAddNote = () => {
    ...
    // In real implementation, this would call an API to add a note
    toast({
      title: "Note Added",
