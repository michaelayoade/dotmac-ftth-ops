 ...
 *
 * Handles SSE connections to /api/isp/v1/realtime endpoints with:
 * - JWT authentication
...
export class SSEEndpoints {
  ...
  onuStatus(config?: Partial<SSEConfig>): SSEClient {
    return createSSEClient({
      endpoint: `${this.baseUrl}/api/isp/v1/realtime/onu-status`,
      ...config,
    });
  }
  ...
  alerts(config?: Partial<SSEConfig>): SSEClient {
    return createSSEClient({
      endpoint: `${this.baseUrl}/api/isp/v1/realtime/alerts`,
      ...config,
    });
  }
  ...
  tickets(config?: Partial<SSEConfig>): SSEClient {
    return createSSEClient({
      endpoint: `${this.baseUrl}/api/isp/v1/realtime/tickets`,
      ...config,
    });
  }
  ...
  subscribers(config?: Partial<SSEConfig>): SSEClient {
    return createSSEClient({
      endpoint: `${this.baseUrl}/api/isp/v1/realtime/subscribers`,
      ...config,
    });
  }
  ...
  radiusSessions(config?: Partial<SSEConfig>): SSEClient {
    return createSSEClient({
      endpoint: `${this.baseUrl}/api/isp/v1/realtime/radius-sessions`,
      ...config,
    });
  }
}
