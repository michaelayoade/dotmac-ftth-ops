...
class PartnerRevenueService {
  ...
  async getRevenueMetrics(filters: RevenueMetricsFilters = {}): Promise<PartnerRevenueMetrics> {
    ...
    const url = `${this.baseUrl}/api/isp/v1/partners/revenue/metrics${
  ...
  async listCommissionEvents(filters: CommissionFilters = {}): Promise<PartnerCommissionEvent[]> {
    ...
    const queryString = params.toString();
    const url = `${this.baseUrl}/api/isp/v1/partners/revenue/commissions${
      queryString ? `?${queryString}` : ""
    }`;
  ...
  async getCommissionEvent(commissionId: string): Promise<PartnerCommissionEvent> {
    const response = await fetch(
      `${this.baseUrl}/api/isp/v1/partners/revenue/commissions/${commissionId}`,
      {
        method: "GET",
        headers: this.getAuthHeaders(),
        credentials: "include",
  ...
  async listPayouts(filters: PayoutFilters = {}): Promise<PartnerPayout[]> {
    ...
    const queryString = params.toString();
    const url = `${this.baseUrl}/api/isp/v1/partners/revenue/payouts${
      queryString ? `?${queryString}` : ""
    }`;
  ...
  async getPayout(payoutId: string): Promise<PartnerPayout> {
    const response = await fetch(`${this.baseUrl}/api/isp/v1/partners/revenue/payouts/${payoutId}`, {
      method: "GET",
      headers: this.getAuthHeaders(),
      credentials: "include",
    });
