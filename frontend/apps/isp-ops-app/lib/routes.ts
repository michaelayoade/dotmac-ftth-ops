...
export const ROUTES = {
  ...
  DASHBOARD: {
    ...
    NETWORK_MONITORING: "/dashboard/network-monitoring",
  ...
  TENANT: {
    ...
    NETWORK_MONITORING: "/tenant/network-monitoring",
...
export const API_ROUTES = {
  ...
  CUSTOMERS: "/api/isp/v1/customers",
  BILLING: "/api/isp/v1/billing",
  NETWORK: "/api/isp/v1/network",
  RADIUS: "/api/isp/v1/radius",
  GENIEACS: "/api/isp/v1/genieacs",
  VOLTHA: "/api/isp/v1/access",
  ACCESS: "/api/isp/v1/access",
  WEBHOOKS: "/api/isp/v1/webhooks",
  INTEGRATIONS: "/api/isp/v1/integrations",
  JOBS: "/api/isp/v1/jobs",
  HEALTH: "/api/isp/v1/health",
  READY: "/api/isp/v1/ready",
} as const;
