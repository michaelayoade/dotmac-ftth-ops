/**
 * Test Utilities for Platform Reseller App
 */
...
/**
 * Mock platform partner data factory
 */
export function createMockPartner(overrides = {}) {
  return {
    id: "partner-123",
    email: "partner@example.com",
    company_name: "Platform Partners Inc",
    contact_name: "Jane Partner",
    phone: "+1234567890",
    partner_code: "PLAT001",
    commission_rate: 15,
    status: "active",
    ...overrides,
  };
...
export function createMockCommission(overrides = {}) {
  return {
    ...
    commission_type: "tenant_subscription",
    created_at: new Date().toISOString(),
    ...overrides,
  };
}
...
export function createMockReferral(overrides = {}) {
  return {
    id: "ref-123",
    tenant_name: "New ISP",
    tenant_email: "newisp@example.com",
    status: "pending",
    tier_selected: "professional",
    referral_code: "PLAT123",
    created_at: new Date().toISOString(),
    ...overrides,
  };
}
