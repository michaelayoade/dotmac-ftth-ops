...
import { useCustomerAuth, CustomerProtectedRoute } from "@/lib/auth";
import { customerConfig } from "@/lib/config";

const navigation = [
  { name: "Dashboard", href: "/portal", icon: Home },
  { name: "My Service", href: "/portal/service", icon: Wifi },
  { name: "Billing", href: "/portal/billing", icon: CreditCard },
  { name: "Usage", href: "/portal/usage", icon: BarChart3 },
  { name: "Support", href: "/portal/support", icon: Headphones },
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/portal" className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg hidden sm:inline-block">
                {customerConfig.branding.productName}
              </span>
            </Link>
          </div>
      ...
      <footer className="border-t mt-auto">
        <div className="container px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            <div>&copy; {new Date().getFullYear()} {customerConfig.branding.companyName}. All rights reserved.</div>
            <div className="flex gap-6">
              <Link href="/portal/support" className="hover:text-primary">
                Help Center
              </Link>
